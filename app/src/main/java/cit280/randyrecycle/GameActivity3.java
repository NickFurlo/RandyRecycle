 ...
 */
public class GameActivity3 extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottleSpeed = Math.round(screenHeight / 110);
        canSpeed = Math.round(screenHeight / 100);
        magSpeed = Math.round(screenHeight / 95);
        milkSpeed = Math.round(screenHeight / 87);
