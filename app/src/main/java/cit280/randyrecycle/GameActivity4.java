 ...
 */
public class GameActivity4 extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //game song By: Sam
        if (gameSong == null) {
            gameSong = MediaPlayer.create(GameActivity4.this, R.raw.game_act); //song from raw folder
        ...
        canSpeed = Math.round(screenHeight / 98);
        magSpeed = Math.round(screenHeight / 87);
        milkSpeed = Math.round(screenHeight / 80);
